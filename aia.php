<?php include "includes/header.php";?>
    <main  class="wrapper container">
          <section class="client-information">
              <h2>Audience, Issues &amp; Approach</h2>
              
                <table id="client-info" class= "client">
                    <tr>
                        <th class = "label1 client">Client</th>
                        <td class = "content1 client">Trevor H.</td>
                    </tr>
                    <tr>
                        <th class = "label2 website-name">Website</th>
                        <td class = "content2 website-name">Press Start</td>
                    </tr>
                    <tr>
                        <th class = "label3 website-status">Redesign/New</th>
                        <td class = "content3 website-status">New</td>
                    </tr>
                    <tr>
                        <th class = "label4 website-type">Website Type</th>
                        <td class = "content4 website-type">Information/Entertainment</td>
                    </tr>
                    <tr>
